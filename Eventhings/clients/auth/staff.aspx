<%@ Page Title="" Language="C#" MasterPageFile="~/clients/auth/auth.Master" AutoEventWireup="true" CodeBehind="staff.aspx.cs" Inherits="Eventhings.clients.auth.staff" %>
    ...
    <section class="contact-content">
        <div class="contact-widget media">
            ...
            <div class="media-body">
                <h6 class="widget-title">New Staff</h6>
                <p class="widget-content">Setup New Staff</p>
            </div>
        </div>
        <div class="contact-widget media">
            <img src="../assets/images/icon-5.png" alt="Eventi.ng.-Book" width="40">
            <div class="media-body">
                <h6 class="widget-title">Manage Staff</h6>
                <p class="widget-content">Having issues with a staff, deativate it here</p>
            </div>
        </div>
    </section>
    <div class="row">
